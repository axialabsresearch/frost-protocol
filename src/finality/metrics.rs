/*!
# Finality Metrics Module

This module provides comprehensive metrics collection and monitoring for the FROST protocol's
finality system. It tracks performance, resource usage, and system health across different
aspects of finality verification.
